...
class Vista {
  ...
  private static function obtieneMenu($deshabilitarmenu){
    ...
    if( !Modelo_Usuario::estaLogueado() ){
      ...
      $menu["menu"][] = array("href"=>PUERTO."://".HOST."/quienesSomos/", "nombre"=>"¿Quienes Somos?");
      $menu["menu"][] = array("href"=>PUERTO."://".HOST."/canea/", "nombre"=>"Test Canea");
      $menu["menu"][] = array("href"=>"https://www.blog.micamello.com.ec/", "nombre"=>"Blog");
      ...
      if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO){           
        ...
        $menu["menu"][] = array("href"=>($deshabilitarmenu) ? "javascript:void(0);" : PUERTO."://".HOST."/quienesSomos/", "nombre"=>"¿Quienes Somos?", "vista"=>"quienesSomos");

        $menu["menu"][] = array("href"=>($deshabilitarmenu) ? "javascript:void(0);" : PUERTO."://".HOST."/canea/", "nombre"=>"Test CANEA","vista"=>"canea");

        $menu["menu"][] = array("href"=>($deshabilitarmenu) ? "javascript:void(0);" : "https://www.blog.micamello.com.ec/", "nombre"=>"Blog", "vista"=>"#");
