                    ...
                    <h3 class="registro-titulo">Registrarse como Candidato</h3>
                        <form action="<?php echo PUERTO.'://'.HOST.'/registroUsuario/' ?>" method="POST" id="registroFormulario" autocomplete="off">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" class="espacio  form-control" placeholder="Apellidos *" name="apellidosCand" id="apellidosCand" <?php echo $readonly; ?>/>
                            </div>
                            <div class="col-md-6 form-group">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <div class="errorContainer"></div>
                                <input type="text" class="espacio form-control" placeholder="Apellidos *" id="apellidoConEmp" name="apellidoConEmp" <?php echo $readonly; ?>/>
                            </div>

                            <div class="col-md-6 form-group">
                                <label class="campo">Celular<span class="no">*</span></label>
                                <div class="errorContainer"></div>
                                <input type="text" class="espacio form-control" placeholder="Celular *" id="tel1ConEmp" name="tel1ConEmp" <?php echo $readonly; ?>/>
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" class="espacio form-control" placeholder="Convencional (opcional)" id="tel2ConEmp" name="tel2ConEmp" <?php echo $readonly; ?>/>
                            </div>
