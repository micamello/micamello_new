<section id="product" class="">
  <div class="text-center">
    <h2 class="blue-text">Publicar Oferta</h2>
  </div>
</section>

<form id="formPublicar" method="POST" action="<?php echo PUERTO.'://'.HOST.'/publicar/' ?>">
	<section id="product" class="container bloque-blue qs-text-3 shadow-box">
	  <div class="container ">
	    <div class="col-md-6">
	      <p style="font-size: 14pt;">Seleccione plan:</p>
	    ...
	    <div class="col-md-6 qs-text-3" style="font-size: 14pt;padding-top: 10px;" id="detallePlan">
	    </div>
	  </div>
	</section>
	 <br>
...
<!-- <option value="1_1" id="array_idioma1" selected="selected"></option> -->
						...
						<div class="col-md-12">
			              <div class="text-center">
			                <input type="submit" name="btnPublicar" id="btnPublicar" class="btn btn-orange" value="Publicar oferta">
			              </div>
			            </div>
