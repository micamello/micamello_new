<section>
  ...
  <div class="text-center">
    <h2 class="blue-text">Env&iacute;enos sus recomendaciones, dudas y sugerencias</h2>
    
    <div class="col-md-12" style="background-color: #f96511;">
      <p class="qs-text-2">Si desea enviarnos sus recomendaciones, dudas y sugerencias, por favor complete  el siguiente cuadro y responderemos lo antes posible.</p>
    </div>
  </div>
  
 <div style="background-color: #00405c;">
  <div class="container bloque-gris" style="padding: 0px;">
      <div class="row">
        <div class="col-md-6 col-md-offset-3">
          <div class="shadow-box" id="inicio-cuadro" style="border-radius: 10px;"> 
