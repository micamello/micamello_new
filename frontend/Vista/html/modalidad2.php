  ...
  <div class="col-md-12">
    <div class="text-center">
      ...
      <div class="con_encabezado">
        ...
        <div align="center">
          <h3 class="metodoTexto"><b class="white-text">Método seleccionado: </b>Arrastrar y soltar
            <img style="width: 10%;" src="<?php echo PUERTO."://".HOST."/imagenes/metodoSel/2.png";?>">
          </h3> 
        </div>
          ...
          <input type="hidden" name="faceta" id="faceta" value="<?php echo $faceta; ?>">
           ...
           <div class="row text-center">
              ...
              <div class="col-md-12">
               ...
               <input type="submit" name="" value="Continuar" class="btn btn-orange">
...
<div class="modal fade" id="msg_inforcuestionario" tabindex="-1" role="dialog" aria-labelledby="msg_inforcuestionario" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <br> 
            <center>
              <button type="button" class="btn btn-orange" data-dismiss="modal">Continuar Test</button>
            </center> 
