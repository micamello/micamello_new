...
<div class="container-fluid">
  <div class="text-center">
    <h2 class="blue-text">Mi Perfil</h2>
  </div>
</div>
<?php
...
<?php } ?>
<div class="container-fluid blue-background"><br>
        ...
        <div class="">
            <div class="col-md-3 col-sm-3 col-xs-12">
                <div style="text-align:center" id="seccion_img" class="recuadro-perfil panel panel-default"><br>
                    ...
                    <?php if( $_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::EMPRESA  ){
                         ...
                         $datos = Modelo_usuario::validaFoto($_SESSION['mfo_datos']['usuario']['id_usuario']);
                          ...
                          if( $datos["foto"] == 1 ){?>
                          	<img id="imagen_perfil" width="70%" alt="fotoPerfil" src="<?php echo PUERTO."://".HOST."/imagenes/usuarios/profile/".$_SESSION['mfo_datos']['usuario']['username'].".jpg"; ?>" style="border-radius: 20px 20px 0px 0px;">
                          <?php }
                          else{?>
                          	<img id="imagen_perfil" width="70%" alt="fotoPerfil" src="<?php echo PUERTO."://".HOST."/imagenes/img-perfil.jpg"; ?>" style="border-radius: 20px 20px 0px 0px;">
                          <?php } ?>
                    <input id="file-input" type="file" name="file-input"  class="upload-photo">
                   	<div class="form-group">
                        ...
                        <label class="btn-orange profile-button" for="file-input">Subir Foto</label>
                ...
                <?php if($puedeDescargarInforme >= 2 && $_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO
				    	...
				    	<div class="col-md-12 recuadro-perfil panel panel-default" style="background-color:#00405c; margin: 10px 0px;padding:0px;"><br>
				    		<a href="<?php echo PUERTO."://".HOST."/fileGEN/informeusuario/".$_SESSION['mfo_datos']['usuario']['username'].'/';?>">
					            <img class="profile-icon" alt="informePersonalidad" src="<?php echo PUERTO."://".HOST."/imagenes/test-icon.png";?>" style="border-radius: 20px 20px 0px 0px;" >
					            <div id="err_img" align="center"><br>
					             <?php if($puedeDescargarInforme >= 2 && $puedeDescargarInforme < 5){?>
					               <label class="btn-orange profile-button" for="">
					                  TEST CANEA 40%
					               </label>
					             <?php echo '<hr><a style="display: initial;" class="texto-white" href="'.PUERTO."://".HOST.'/planes/">
						        		<span class="crown-ph" style="padding:10px 0px; color:#fff; text-align:center;">
						        		    Completa tu Test CANEA<br>
						        		    <small class="premium-profile">Te ayudara a destacar en las busquedas</small>
						        		</span></a>';
					        		    }
					                    else{ echo ' <label class="btn-orange profile-button" for="">TEST CANEA </label>'; } ?>
					            </div>
					            <br>
				        	</a>
                ...
                <?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO){ 
                	...
                	<div id="hoja_de_vida" style="padding:0px;margin: 10px 0px; cursor:pointer;" class="col-md-12 recuadro-perfil panel panel-default">	
                		<?php if($btnDescarga == 1){ ?><br>
                		    <img class="profile-icon" alt="hoja_de_vida" src="<?php echo PUERTO."://".HOST."/imagenes/hv-icon.png";?>" style="border-radius: 20px 20px 0px 0px;" >
                		    <br><br>
                    		<label class="btn-orange profile-button" id="hoja_de_vida"> Hoja de vida <br><small class="mb-profile">(.PDF, .doc, .docx/máx: <?php echo (PESO_ARCHIVO/1000000) ?>MB)</small></label>
                    	...
                    	<?php }
                    		...
                    		<img class="col-md-3 profile-icon" alt="hoja_de_vida" src="<?php echo PUERTO."://".HOST."/imagenes/hv-icon.png";?>" style="border-radius: 20px 20px 0px 0px;" >
                		    <br><br>
                    		<label class="btn-orange profile-button" id="hoja_de_vida"> Hoja de vida <br><small class="mb-profile">(.PDF, .doc, .docx/máx: <?php echo (PESO_ARCHIVO/1000000) ?>MB)</small></label>
                ...
                <div data-toggle="modal" data-target="#cambiar_clave" data-whatever="@mdo" style="cursor:pointer; padding:0px;margin: 10px 0px; background-color:#00405c;" class="col-md-12 recuadro-perfil panel panel-default">
                  <img class="profile-icon" alt="cambio_clave" src="<?php echo PUERTO."://".HOST."/imagenes/pass-ch-icon.png";?>" style="border-radius: 20px 20px 0px 0px;" ><br>
			        <label class="profile-button" for=""><span class="text-pass">Cambiar Contrase&ntilde;a</span></label>
		        </div>
	                    ...
	                    <div class="">
				            <div class="">
	                                ...
	                                <div class="col-md-12">
	                                    ...
	                                    <div class="col-md-6">
	                                        <div id="seccion_nombre" class="form-group">
	                                            <label for="nombres">
	                                            	<?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { ?> Nombres <?php 
	                                            	      }
	                                            	      else{ ?> Nombre de la empresa<?php } ?>
	                                            	      	<span title="Este campo es obligatorio" class="requerido">*</span>
	                                            </label>
	                                            <div id="err_nom" class="help-block with-errors"></div>
	                                    ...
	                                    <?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { ?>
											...
											<div class="col-md-6" data-placement="left"  data-html="true" data-original-title="<i class='fa fa-info-circle fa-2x'></i><br/><p>Esta informaci&oacute;n ser&aacute; tomada en cuenta para sus <a href='<?php echo PUERTO."://".HOST;?>/preguntasfrecuentes/'>autopostulaciones</a>. </p>">
		                                    ...
		                                    <div class="col-md-12 col-sm-12 col-lg-6" data-placement="left" data-html="true" data-original-title="<i class='fa fa-info-circle fa-2x'></i><br/><p>Esta informaci&oacute;n ser&aacute; tomada en cuenta para sus <a href='<?php echo PUERTO."://".HOST;?>/preguntasfrecuentes/'>autopostulaciones</a>. </p>">
					            ...
					            <div class="col-md-12"></div>
					                ...
					                <div align="center">
					                	<input type="button" id="boton" name="" class="btn btn-orange" value="<?php echo ($textoboton != "" && isset($textoboton)) ?  $textoboton:  "CONTINUAR" ?>">
										<?php if($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { 
											$defaultnext = "cuestionario";											
											if(!isset($_SESSION['mfo_datos']['usuario']['infohv']) && $ca > 2){$defaultnext = "cargarhojavida";}
											?>
										<?php }else{ 	?>
											<a href="<?php echo PUERTO."://".HOST;?>/publicar/" class="btn btn-blue-basic <?php if($btnSig == 0){ echo ''; } ?>" <?php if($btnSig == 0){ echo ''; } ?>>PUBLICAR OFERTA</a>
									    <?php } ?>
      ...
      <div class="modal-header">
        <h5 class="titulo-modal-hoja modal-title">Cambio de Contrase&ntilde;a</h5>                  
	      ...
	      <div class="modal-footer" style="text-align: center !important;">	
	        <button type="button" class="btn btn-orange" style="margin-bottom: 0px;" id="btn-rojo" data-dismiss="modal">Cancelar</button>
			<input type="button" id="button_cambiar" name="button_cambiar" class="btn btn-blue-basic" value="Cambiar">
	      </div>
  		</form>
    </div>    
  </div>
      ...
      <div class="modal-header">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
              <div class="col-md-12">
                <p>Puede actualizar o descargar su hoja de vida. Recuerde solo se permiten los formatos .pdf, .doc, .docx, con un peso m&aacute;ximo de <?php echo (PESO_ARCHIVO/1000000) ?>MB </p>
        ...
        <div class="modal-footer" style="text-align: center !important;">	
        	<label class="btn btn-blue-basic" for="subirCV" style="cursor:pointer">actualizar</label>
      		<input type="hidden" name="" id="btnDescargarHV" value="<?php echo $_SESSION['mfo_datos']['usuario']['infohv']; ?>">
      		<a href="<?php echo $ruta_arch; ?>" class="btn btn-orange">descargar</a>
        </div>
    </div>    
  </div>
</div>﻿