    ...
    <div class="main_business">                                                                                    
      <div class="container">
        <div class="text-center">
          <h2 class="blue-text">M&eacute;todos de Pago</h2>
          <input type="hidden" name="tipoSeleccionado" id="tipoSeleccionado" value="">
        </div>
        <br>
        <div class="qs-text-2 shadow-box" align="center" style="background-color: #f96511;">     
              ...
              <div class="col-xs-12 col-md-12">
                ...
                <div class="col-md-6"> 
                  <div id="seccion_dirPM" class="form-group"> 
                    ...
                    <input type="text" name="shippingAddress" id="shippingAddress" class="form-control" value="" maxlength="100" />
                  </div>
                </div>
