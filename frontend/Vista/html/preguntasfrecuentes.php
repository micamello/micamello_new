<section id="product">
  <div class="text-center">
    <h2 class="blue-text">Preguntas y Respuestas Frecuentes</h2>
  </div>
</section>
          ...
          <div class="col-md-2">
            <ul style="border: none;" class="nav nav-tabs">
              <?php if(count($candidatos) > 0) { ?>
                <li class="faq-lista active"><a class="faq-tab" data-toggle="tab" href="#candidatos" aria-expanded="true"><span class="text-shadow">Candidatos</span></a></li>
              <?php } ?>

              <?php if(count($empresas) > 0) { ?>
                <li class="faq-lista"><a class="faq-tab" data-toggle="tab" href="#empresas"><span class="text-shadow">Empresas</span></a></li>
              <?php } ?>
            </ul>
          </div>
