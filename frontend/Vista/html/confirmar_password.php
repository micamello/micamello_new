...
<!--<section id="product" class="product">-->
  <div class="container">
    <div class="text-center">
      <h2 class="blue-text">Cambio de Contrase&ntilde;a</h2>
    </div>
  </div>
              ...
              <div class="col-md-12">
                <div class="form-group" id="seccion_clave">
                  ...
                  <div class="input-group">
                    ...
                    <input title="Letras y números, mínimo 8 caracteres" 
                           type="password" name="pass1" id="pass1" 
                           onchange="this.setCustomValidity(this.validity.patternMismatch ? this.title : ''); 
                           if(this.checkValidity()) form.password2.pattern = this.value;"
                             class="form-control <?php echo $noautofill; ?>" 
                             maxlength="15" minlength="8" 
                             onkeyup="validaForm(2,'recuperar')" <?php echo $readonly; ?>>
                  </div> 
              ...
              <div class="row">          
                <div class="col-xs-12">
                  <div class="text-center" style="margin-top: 20px;">
                    <button type="button" class="btn-blue" onclick="validaForm(2,'recuperar')" id="recuperar">Cambiar Password</button>
                  </div>
                </div>
              </div>
            </form>
