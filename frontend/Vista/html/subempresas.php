<div class="container">
  <div class="row">
    <div class="text-center">
      <h2 class="blue-text">Administraci&oacute;n de la cuenta</h2>
    </div><br>
      ...
      <section>
        ...
        ?>
          ...
          <div class="col-md-4 col-sm-12">
            <div class="caja-cuenta back-orange">
                    ...
                    <div class="panel-body">
                        ...
                        <?php  if($cantd_cuentas > 0 && $puedeCrearCuenta == 1){ ?>
                            <div style="margin: 10px 0px;" class="col-md-12 icon_oferta">
                                <a class="btn-blue" href="<?php echo PUERTO."://".HOST;?>/crearEmpresas/">
                                    <span id="boton" name="">
                                        <i class="fa fa-building hidden-sm hidden-xs" title="Crear nueva empresa"></i> 
                                        CREAR SUBCUENTA
                                    </span>
                                </a>
                            </div> 
                      ...
                      <div style="overflow-x:auto; width: 100%">
                        <table class="table table-bordered table-hover">
                            <thead >
                                <tr class="breadcrumb etiquetaBody">
