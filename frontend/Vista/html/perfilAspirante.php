<div class="text-center">
    <h2 class="blue-text">Perfil del Candidato</h2>
  </div>
		...
		<div class="panel panel-default shadow">
			<div class="panel-body">
				<div class="fotoPerfil">
					<div class="text-center">
						<div class="col-md-6">
							<?php $datos = Modelo_usuario::validaFoto($datosUsuario['id_usuario']);
							if( $datos["foto"] == 1 ){?>
                          	  <img class="perfil_photo_user" src="<?php echo PUERTO.'://'.HOST.'/imagenes/usuarios/profile/'.$datosUsuario['username'].'.jpg';?>"> 
                          <?php }
                          else{?>
                          	<img class="perfil_photo_user" src="<?php echo PUERTO.'://'.HOST.'/imagenes/user.png';?>">
                          <?php } ?>
						</div>
					</div>
				</div>
