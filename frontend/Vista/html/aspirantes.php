...
<div class="container-fluid">
	...
	if(!empty($limite_plan) && $_SESSION['mfo_datos']['usuario']['cantd_total'][Utils::desencriptar($id_oferta)] > $limite_plan){ ?>
		<br>
		<div class="alert back-orange col-md-12"> 
			<i class="fa fa-info-circle"></i> Usted tiene un <b>Plan <?php echo utf8_encode($nombre_plan); ?></b>, en esta oferta existen <b><?php echo $_SESSION['mfo_datos']['usuario']['cantd_total'][Utils::desencriptar($id_oferta)]; ?> postulados</b> pero solo puede visualizar <b><?php echo $limite_plan; ?></b>.
	...
	<?php if(!empty($_SESSION['mfo_datos']['Filtrar_aspirantes']['R'])){ ?>
		<br>
		<div class="alert back-orange col-md-12" style="font-size: 14pt;"> 
						...
						if (!empty($facetas)) {
							...
							foreach ($facetas as $key => $v) {
								...
								echo '<div id="fac_'.$i.'" style="float:left;width: 90%;"><div class="p-3">
						            ...
						            </div></div><div id="btn_'.$i.'" data-html="true" data-original-title="<i class=\'fa fa-info-circle fa-2x\'></i><br/>" style="float:right;padding-top: 40px;cursor:pointer"><a onclick="verFacetas(\''.$letra.'\','.$pos.')"><i class="fa fa-search"></i></a></div>';
								$i++;
							}
							...
							echo "<div class='clearfix'></div><br><a style='display:none' id='btn_consultar' name='btn_consultar' data-html='true' data-original-title='<i class=\"fa fa-info-circle fa-2x\"></i><br/>' class='btn btn-default' href='#'><i class='fa fa-search'></i></a></div>";
						}else{
			...
			<?php if(($vista == 1 && $num_accesos_rest > 0 && $empresa_hija == true && $datosOfertas['estado'] == Modelo_Oferta::ACTIVA) || $vista == 2){ ?> 
				...
				<div <?php echo $style_activo; ?> id="activarAccesos" class="pull-right">
		          <h6 style="color:#6d6d6b">
		            <button style="float: right;" id="activar-accesos" type="button" class="btn btn-blue-basic" data-placement="bottom" data-toggle="tooltip" data-html="true" title="" data-original-title="<i class='fa fa-info-circle fa-2x'></i><br/><p>Buenas noticias, puedes enviar accesos a los candidatos que elijas para que rindan el test completo.</p>">Activar accesos</button>
		          </h6>
					...
					<?php if($vista == 1){ ?> 
						<div class="col-md-12" align="right" style="font-size: 14pt;"> 
				          <b style="text-transform: uppercase;">Número de accesos restantes: 
				            <span class="parpadea text-parpadea"><?php echo $num_accesos_rest; ?></span>
				          </b><br>
				          <b>
			                	...
			                	<thead class="etiquetaBody">
							    	<tr>
							    		<?php if($empresa_hija){ ?>
								      	...
								      	<th rowspan="2" style="vertical-align: middle; text-align: center;" class="link-ord">Visto</th>
								      	<th rowspan="2" style="vertical-align: middle; text-align: center;" class="link-ord">Foto</th>
										<th rowspan="2" colspan="1" style="vertical-align: middle; text-align: center;" class="link-ord">Nombre y Apellido</th>
								        <th rowspan="2" style="vertical-align: middle; text-align: center;width: 100px">
											...
											?>
								           <a class="link-ord" href="<?php echo $ruta.'1/'; ?>">Edad <i class="fa fa-sort"></i></a>
								        </th>
								        <?php if($vista == 1) { ?>
									        <th rowspan="2" style="vertical-align: middle; text-align: center;">
												...
												?>
									           <a class="link-ord" href="<?php echo $ruta.'1/'; ?>"><?php echo 'Postulado hace'; ?><i class="fa fa-sort"></i></a>
									        </th>
								    	<?php } ?>
								    	<th colspan="5" class="link-ord" style="vertical-align: middle; text-align: center;">INFORME <i data-placement="bottom" data-toggle="tooltip" data-html="true" data-original-title="<i class='fa fa-info-circle fa-2x link-ord'></i><br/><p>Es un resumen de las características generales por competencias que describe al candidato. </p>" style="padding-left: 5px;font-size: 18px;cursor:help;" class="fa fa-question-circle-o" aria-hidden="true"></i></th>
								        <th rowspan="2" style="vertical-align: middle; text-align: center;" title="Nivel de Estudios">
											...
											?>
								           <a class="link-ord" href="<?php echo $ruta.'1/'; ?>">Estudios<i class="fa fa-sort"></i></a>
								       </th>
								        ...
								        <?php if($vista == 1) { ?>
									        <th rowspan="2" style="width: 100px; vertical-align: middle; text-align: center;" title="Aspiraci&oacute;n Salarial">
												...
												?>
									           <a class="link-ord" href="<?php echo $ruta.'1/'; ?>">Salario<i class="fa fa-sort"></i></a>
									       </th>
									   <?php } ?>
									   	<?php if($empresa_hija){ ?>
								        	<th rowspan="2" colspan="2" style="vertical-align: middle; text-align: center;" class="link-ord">Acci&oacute;n</th>
								    	<?php } ?>
							      	</tr>
							      	<tr><?php 
								    	foreach($facetas as $key => $nombre){ 
								    		echo "<th class='link-ord' style='vertical-align: middle; text-align: center;'>".$nombre['literal']."</th>";
								    	} ?>
								    </tr>
							    </thead>
				        		<tbody>
							            	...
							            	<tr<?php echo $color; ?>>
							            		...
							            		<td style="text-align: center; vertical-align: middle;">
							            			...
							            			<?php
							            				...
							            				if( $estilo == 'color: #CDCDCD;' ){?>
							            				   <img src="<?php echo PUERTO.'://'.HOST.'/imagenes/icono-visible-inactivo.png';?>"  class="eye">
							            				  <?php } else{?> 
							            				  <img src="<?php echo PUERTO.'://'.HOST.'/imagenes/icono-visible-activo.png';?>"  class="eye">
							            				<?php }?>
							            		</td>
							            		...
							            		<td align="right" style="text-align: center; vertical-align: middle;" data-title="Foto:">
							            			<?php 
							            		if( $a['foto'] == 1 ){
							            			$src_imagen = PUERTO.'://'.HOST.'/imagenes/usuarios/profile/'.$a['username'].'-thumb.jpg';
							            		}
							            		else{
							            			$src_imagen = PUERTO.'://'.HOST.'/imagenes/user.png';
							            		}?>

							                      <img class="imagen-perfil-2" src="<?php echo $src_imagen; ?>" alt="perfil" width="50" height="50">
							                    </td>
							            		
							            		
							            		<td data-title="Aspirante: " class="text-aspirante" style="vertical-align: middle; text-align: center;">
								            			...
								            			if (isset($_SESSION['mfo_datos']['planes']) && Modelo_PermisoPlan::tienePermiso($_SESSION['mfo_datos']['planes'], 'detallePerfilCandidatos',$id_plan) && $_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::EMPRESA && $ver == true) {
								            				...
								            				if($empresa_hija){
								            					...
								            					if($datosOfertas['estado'] == Modelo_Oferta::ACTIVA){
								            						echo '<a class="text-aspirante" href="'.PUERTO."://".HOST."/aspirante/".$a['username'].'/'.$id_oferta.'/'.$vista.'/">';
								            					}
								            				}
								            				...
								            				if(!$ver){ 
								            					...
								            					echo '<a href="#" class="link-ord" onclick="abrirModal(\'Debe contratar un plan que permita ver los datos del candidato\',\'alert_descarga\',\''.PUERTO."://".HOST."/planes/".'\',\'Ok\',\'\')">'.$a['nombres'].' '.$a['apellidos'].'</a>';
								            				} 
								            			} 
							            			?>
												</td>
												
							            		<td data-title="Edad: " style="vertical-align: middle; text-align: center;" class="text-center text-aspirante"><?php echo $a['edad']; ?></td>
													<?php if($vista == 1){ 
													...
													?>
							            			<td data-title="Postulado hace: " style="vertical-align: middle; text-align: center;" class="text-aspirante text-center"><?php echo $diff->days . ' d&iacute;as'; /*echo date("d", strtotime($a['fecha_postulado'])).' de '.MESES[date("m", strtotime($a['fecha_postulado']))].', '.date("Y", strtotime($a['fecha_postulado']));*/ ?></td>
												<?php } $cont = 1;?>
												
												<?php foreach($facetas as $key => $nombre){
										    		echo "<td class='text-aspirante' data-title='".$nombre['literal']/*substr($nombre, 0,1)*/.":' style='vertical-align: middle; text-align: center;'>";
										    		$varValue = 0;
												...
												<td data-title="Estudios: " class="text-aspirante" style="vertical-align: middle; text-align: center;"><?php echo utf8_encode($a['estudios']); ?></td>

												<?php if($vista == 1){ 
													$compl_url = $id_oferta."/"; ?>
													<td data-title="Salario: " class="text-aspirante" style="vertical-align: middle; text-align: center;"><?php echo SUCURSAL_MONEDA.number_format($a['asp_salarial'],2); ?></td>
												<?php }else{
													$compl_url = '';
												} ?>
												...
												<?php if($empresa_hija){ 
													...
													$imagen = '';
													echo '<td class="text-aspirante" title="Descargar Informe de competencias laborales ';
									            		...
									            		if (isset($_SESSION['mfo_datos']['planes']) && Modelo_PermisoPlan::tienePermiso($_SESSION['mfo_datos']['planes'], 'descargarInformePerso',$id_plan) && $_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::EMPRESA && $ver == true) {
									            			if($mostrar == ''){
									            				...
									            				if($datosOfertas['estado'] == Modelo_Oferta::ACTIVA){
									            					$variable = '<a class="accionOpcion" onclick="hacerInforme(\''.PUERTO."://".HOST."/fileGEN/informeusuario/".Utils::encriptar($id_plan).'/'.$id_oferta.'/'.$a['username'].'\',\''.Utils::encriptar($a['id_usuario']).'\')"><img src="'.PUERTO."://".HOST.'/imagenes/'.$imagen.'" class="redes-mic"></a>';
									            				}else{
																	$variable = '<img src="'.PUERTO."://".HOST.'/imagenes/'.$imagen.'" class="redes-mic">';
																}
															...
															if($mostrar == ''){
																if(!$ver){
																	...
																	echo '<a href="#" onclick="abrirModal(\'Debe contratar un plan que permita descargar informes de competencias laborales\',\'alert_descarga\',\''.PUERTO."://".HOST."/planes/".'\',\'Ok\',\'\')"><img src="'.PUERTO."://".HOST.'/imagenes/'.$imagen.'" class="redes-mic"></a>';
																}
															}else{
																echo $mostrar;
															}
													...
													<td title="Descargar Hoja de vida" class="text-aspirante" data-title="Hoja de vida: " style="vertical-align: middle; text-align: center;">
									            		<?php 
										            		if (isset($_SESSION['mfo_datos']['planes']) && Modelo_PermisoPlan::tienePermiso($_SESSION['mfo_datos']['planes'], 'descargarHv',$id_plan) && $_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::EMPRESA && $ver == true) {
										            			...
										            			if($datosOfertas['estado'] == Modelo_Oferta::ACTIVA){
										            				echo '<a class="accionOpcion" href="'.PUERTO."://".HOST."/hojasDeVida/".$a['username'].'/'.$compl_url.'"><img src="'.PUERTO."://".HOST.'/imagenes/cv-07.png" class="redes-mic"></a>';
										            			}else{
																	echo '<img src="'.PUERTO."://".HOST.'/imagenes/cv-07.png" class="redes-mic">';
										            			}
															}else{
																if(!$ver){
																	echo '-';
																}else{
																	echo '<a href="#" onclick="abrirModal(\'Debe contratar un plan que permita descargar hojas de vida\',\'alert_descarga\',\''.PUERTO."://".HOST."/planes/".'\',\'Ok\',\'\')"><img src="img/cv-07.png" class="redes-mic"></a>';
																}
															}
														?>
													</td>
			...
			<?php if($empresa_hija){ ?>
				<div class="col-md-12">
					...
					<div <?php echo $style_desactivo; ?> id="desactivarAccesos_btn" class="pull-right">
						<a id="btn_accesos_cancelar" class="btn btn-orange">Cancelar</a>
						<a id="btn_accesos_confirmar" class="btn btn-blue-basic ">Enviar accesos</a>
					</div>
				</div>
			<?php } ?>
		<?php 
			// if(!empty($limite_plan) && $_SESSION['mfo_datos']['usuario']['cantd_total'][Utils::desencriptar($id_oferta)] > $limite_plan){
			if(!empty($limite_plan) && $_SESSION['mfo_datos']['usuario']['cantd_total'][Utils::desencriptar($id_oferta)] >= 1){  
				if(isset($_SESSION['mfo_datos']['usuario']['ofertaConvertir']) && !empty($_SESSION['mfo_datos']['usuario']['ofertaConvertir'])){ 
					...
					<div id="convertirOferta">
					  <div class="col-md-12" style="background-color: #f96511;">
				        <p class="qs-text-2"><i class="fa fa-info-circle"></i> Si desea ver m&aacute;s perfiles de candidatos, convierte tu oferta &oacute; adquiere un nuevo plan con m&aacute;s beneficios.</p>
				      </div>
				      <div class="col-md-12">
				      	<br>
				      	<button id="btn_convertir" type="button" class="btn btn-blue" data-placement="bottom" data-toggle="tooltip" data-html="true" title=""><?php if(count($planes)!=0){ echo 'CONVIERTE LA OFERTA'
							; }else{ echo 'ADQUIERE UN PLAN'; } ?> AQUI</button>
				      </div>
					</div>
				<?php 
				} 
