...
class Controlador_Velocimetro extends Controlador_Base {
  ...
  public function mostrarDefault($faceta){
    ...
    elseif ($faceta == 2) {
      ...
      $msj2 = '¡Excelente! Ha completado el 2do test, ahora sus posibilidades se han incrementado. Mejore sus oportunidades al completar 3er TEST CANEA. No desespere, recuerde que obtendrá mejores resultados y beneficios para su carrera profesional';
